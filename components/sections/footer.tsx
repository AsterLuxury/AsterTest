...
import { Gem, Instagram, Mail } from "lucide-react";
    ...
    <footer id="contact">
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p className="footer-tag">
              Curated fine jewelry for the modern romantic.
            </p>
          </div>
          ...
          <div className="footer-col">
            ...
            <span className="footer-note">Delivery available across Iraq</span>
          </div>
        </div>

        <div className="footer-massive" aria-hidden="true">
          aster<em>luxury</em>
        </div>
        ...
        <div className="footer-bottom">
          ...
          <span>
            Made with <Gem size={12} aria-hidden style={{ display: "inline", verticalAlign: "middle" }} /> for you
          </span>
        </div>
      </div>
    </footer>
