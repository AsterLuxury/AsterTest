...
/**
 * Panel 8 — Footer cover.
 *
 * A near-full-viewport ink panel. Massive italic wordmark dominates,
 * with a tiny grid of links and contact info underneath — like the
...
export function V4Footer() {
  ...
  return (
    <footer id="contact" className="v4-footer">
      <span className="v4-footer__chapter">VI. End matter.</span>

      <div className="v4-footer__massive" aria-hidden>
        Aster
        <em>Luxury</em>
      </div>
      ...
      <div className="v4-footer__cols">
        <div>
          <span className="v4-footer__lbl">Boutique</span>
          <span className="v4-footer__row">Erbil, Iraq</span>
          <span className="v4-footer__row">Founded 2023</span>
        </div>

        <div>
          <span className="v4-footer__lbl">Reach us</span>
          <a
            className="v4-footer__row"
          ...
          <a className="v4-footer__row" href={`mailto:${CONTACT_EMAIL}`}>
            <Mail size={12} aria-hidden strokeWidth={1.25} /> {CONTACT_EMAIL}
          </a>
        </div>

        <div>
          <span className="v4-footer__lbl">Sitemap</span>
          <Link className="v4-footer__row" href="#home">
            Home
          </Link>
          <Link className="v4-footer__row" href="#story">
            Story
          </Link>
          <Link className="v4-footer__row" href="#collections">
            The Edit
          </Link>
          <Link className="v4-footer__row" href="#shop">
            Shop
          </Link>
          <Link className="v4-footer__row" href="#faq">
            FAQ
          </Link>
        </div>
      </div>
